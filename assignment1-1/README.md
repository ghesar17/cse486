...
```
<p>Make sure you have let us know your github username (check out "To-Do List" on Piazza), so we can link your Github username to your UBITname for assignment grading.</p>

<p>Submit your assignment on Autolab (https://autolab.cse.buffalo.edu/). Sign in with your MyUB, select CSE486/586 Distributed Systems (f24), assignment1-1, enter the commit tag, e.g., a11-handin, check the academic integrity box, and submit.</p>
